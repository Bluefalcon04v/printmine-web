  ...
  return (
    <div className="p-8 grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="shadow-lg p-6 text-center rounded-2xl h-56 flex flex-col justify-center relative overflow-hidden">
        <Image src="/sampleImage.jpg" alt="Keychain" layout="fill" objectFit="cover" className="absolute inset-0 w-full h-full object-cover opacity-70" />
      ...
      <div className="row-span-2 shadow-lg p-8 flex flex-col items-center justify-center text-center rounded-2xl h-full relative overflow-hidden">
        <Image src="/sampleImage.jpg" alt="Premium Pens" layout="fill" objectFit="cover" className="absolute inset-0 w-full h-full object-cover opacity-30" />
      ...
      <div className="shadow-lg p-6 text-center rounded-2xl h-56 flex flex-col justify-center relative overflow-hidden">
        <Image src="/sampleImage.jpg" alt="Badge" layout="fill" objectFit="cover" className="absolute inset-0 w-full h-full object-cover opacity-70" />
        <h3 className="text-xl font-bold text-black relative z-10">MAGNETIC BADGES</h3>
      </div>

      <div className="shadow-lg p-6 text-center rounded-2xl h-56 flex flex-col justify-center relative overflow-hidden">
        <Image src="/sampleImage.jpg" alt="Metal Pen" layout="fill" objectFit="cover" className="absolute inset-0 w-full h-full object-cover opacity-70" />
      ...
      <div className="shadow-lg p-6 text-center rounded-2xl h-56 flex flex-col justify-center relative overflow-hidden">
        <Image src="/sampleImage.jpg" alt="Card Holder" layout="fill" objectFit="cover" className="absolute inset-0 w-full h-full object-cover opacity-70" />
